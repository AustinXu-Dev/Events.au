...
struct EventUnitMock  {
    ...
    let eventUnitA = EventUnitModel(_id: "661e3b32be3f0f96c295ee62", eventId: EventModel(_id: "661e3b32be3f0f96c295ee5c", name: "event testing 15:47", description: "This event is Events.AU pilot launching event.", startDate: Date().formattedDateAndMonth(), endDate: Date().formattedDateAndMonth(), startTime: Date().formattedTime(), endTime: Date().formattedTime(), location: "ABAC", rules: "There is no rules", coverImageUrL:  "https://picsum.photos/1200", adminId: "661ff7eb38ad5b5348ac79ba", status: "approved"), unitId: UnitModel(_id: "661e1d459d67f48368bafbb6", name: "unit 1", description: "testing unit create route"))
