...
//    let participantB = ParticipantModel(_id: "664455d8168e2d6ca4eb8101", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventB, organzierId: OrganizerMock.instance.organizer2, status: "approved", email: "admin7@gmail.com", phone: 0928999292)
    ...
    let participantA = ParticipantModel(_id: "8471741885", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventA, status: "participating")
    let participantB = ParticipantModel(_id: "1985815818", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventA, status: "pending")
...
//    ]
    ...
    let participants = [
        ParticipantModel(_id: "179365617937", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventB, status: "pending"),
        ParticipantModel(_id: "418108518515", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventA, status: "pending"),
        ParticipantModel(_id: "585187518858", userId: UserMock.instance.user3, eventId: EventMock.instacne.eventB, status: "pending")
    ]
